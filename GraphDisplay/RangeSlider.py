...
class RangeSliderH(Frame):
    ...
    def __init__(self, master, variables, Width = 400, Height = 80, min_val = 0, max_val = 1, padX=3,
                    ...
                    step_size = 0,step_marker=False, cross_each_other = False, ValueChangeCB=None):
        ...
        RangeSliderH.ValueChangeCB=ValueChangeCB
        if auto:
    ...
    def __setValues(self):
        ...
        bChanged = (self.variables[0].get() != values[0]) or (self.variables[1].get() != values[1])
        self.variables[0].set(values[0])
        self.variables[1].set(values[1])
        if (bChanged and (self.ValueChangeCB != None)) :
            self.ValueChangeCB()
...
class RangeSliderV(Frame):
    ...
    def __init__(self, master, variables, Width = 80, Height = 400, min_val = 0, max_val = 1, padY=3,
        ...
        RangeSliderV.ValueChangeCB=ValueChangeCB
        if auto:
